      ...
      <header className="border-b border-surface-200/80 bg-white/85 backdrop-blur-sm sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="inline-flex rounded-xl border border-surface-200 p-1 bg-white w-full md:w-auto">
              <WorkspaceToggle
...
function WorkspaceToggle({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors flex-1 md:flex-none ${
        active
